...
--	end
    ...
    daters.set_matrix_rotation = function (x, y, z)
	set_matrix_rotation(daters.matrix, x, y, z);
    end
    
    daters.set_quaternion_rotation = function(w, x, y, z)
	set_quaternion_rotation(daters.matrix, w, x, y, z);
    end
...
-- model class instance, diameter, number of segments
create_sphere = function(s, diameter, segments, origin_x, origin_y, origin_z, image) 
    ...
    for latitude = 1, segments, 1 do
		...
		img_x3, img_y3, img_x4, img_y4 = 0, 0, 0, 0;
	    end
