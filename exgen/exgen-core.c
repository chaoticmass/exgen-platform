...
//    lua_register(L, "download_mod", l_download_mod); lua_register_help(L, "download_mod", "", "", "", "core");
    ...
    lua_register(L, "run_stringthread", l_runstringthread);    
    ...
    //lua_register(L, "store_result", l_store_result);
...
void *lua_runscript_thread_reuse (void * L, char *file ) {
    ...
    ret = pthread_create(&tid, &tattr, lua_lua_dofile, lua_data);
