...
model_rx_input.text = entity[1].r_x;
...
model_rz_input.text = entity[1].r_z;
...
model_scale_input.text = entity[1].scale;
model_scale_input.drag = 0;

model_scale_input.on_return = function () 
    entity[1].scale = model_scale_input.text;
end
...
model_x_input.on_return = function () 
    entity[1].x = model_x_input.text;
    entity[1].body.set_position(entity[1].x, entity[1].y, entity[1].z);
end
...
model_rx_input.on_return = function () 
    entity[1].r_x = model_rx_input.text;
    entity[1].body.set_rotation(entity[1].r_x, entity[1].r_y, entity[1].r_z);
    entity[1].body.set_position(entity[1].x, entity[1].y, entity[1].z);
end
...
model_ry_input.on_return = function () 
    entity[1].r_y = model_ry_input.text;
    entity[1].body.set_rotation(entity[1].r_x, entity[1].r_y, entity[1].r_z);
    entity[1].body.set_position(entity[1].x, entity[1].y, entity[1].z);
end
...
model_rz_input.on_return = function () 
    entity[1].r_z = model_rz_input.text;
    entity[1].body.set_rotation(entity[1].r_x, entity[1].r_y, entity[1].r_z);
    entity[1].body.set_position(entity[1].x, entity[1].y, entity[1].z);
end
