...
--run_script_thread_reuse("apps/talk/talk.lua");
--run_script_thread_reuse("apps/networking/server.lua");
--run_script_thread_reuse("apps/gif.lua");
run_script_thread_reuse("apps/latex2.lua");
--run_script_thread_reuse("apps/memory_meter.lua");
--run_script_thread_reuse("apps/destrado/rain.lua");
--run_script_thread_reuse("apps/inventory_search.lua");
