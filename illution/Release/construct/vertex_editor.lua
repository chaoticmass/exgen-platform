--[[
    ...
    Cycle through the vertexes in a model.
    
    

]]

ve_window = window:new();
ve_window.font = title_font;
ve_window.top = 0;
ve_window.left = 0;
ve_window.width = 320;
ve_window.height = 240;
ve_window.visible = 1;
ve_window.caption = "Entity Properties";
echo(ve_window.surface.." ve_window \n");

model_x_label = label:new();
model_x_label.parent = ve_window;
model_x_label.font = body_font;
model_x_label.top = ve_window.align_top(model_x_label);
model_x_label.left = ve_window.align_left(model_x_label);
model_x_label.caption = "X:";

model_x_input = inputbox:new();
model_x_input.parent = ve_window;
model_x_input.font = body_font;
model_x_input.top = model_x_label.top;
model_x_input.left = ve_window.align_left(model_x_input);
model_x_input.text = entity[4].x;
model_x_input.drag = 0;

model_rx_label = label:new();
model_rx_label.parent = ve_window;
model_rx_label.font = body_font;
model_rx_label.top = model_x_label.top;
model_rx_label.left = ve_window.align_left(model_rx_label);
model_rx_label.caption = "RX:";

model_rx_input = inputbox:new();
model_rx_input.parent = ve_window;
model_rx_input.font = body_font;
model_rx_input.top = model_rx_label.top;
model_rx_input.left = ve_window.align_left(model_rx_input);
model_rx_input.text = entity[4].r_x;
model_rx_input.drag = 0;


ve_window.align_clear_left();

model_y_label = label:new();
model_y_label.parent = ve_window;
model_y_label.font = body_font;
model_y_label.top = ve_window.align_top(model_y_label);
model_y_label.left = ve_window.align_left(model_y_label);
model_y_label.caption = "Y:";

model_y_input = inputbox:new();
model_y_input.parent = ve_window;
model_y_input.font = body_font;
model_y_input.top = model_y_label.top;
model_y_input.left = ve_window.align_left(model_y_input);
model_y_input.text = entity[4].y;
model_y_input.drag = 0;

model_ry_label = label:new();
model_ry_label.parent = ve_window;
model_ry_label.font = body_font;
model_ry_label.top = model_y_label.top;
model_ry_label.left = ve_window.align_left(model_ry_label);
model_ry_label.caption = "RY:";

model_ry_input = inputbox:new();
model_ry_input.parent = ve_window;
model_ry_input.font = body_font;
model_ry_input.top = model_ry_label.top;
model_ry_input.left = ve_window.align_left(model_ry_input);
...
model_scale_label.parent = ve_window;
model_scale_label.font = body_font;
model_scale_label.top = ve_window.align_top(model_scale_label);
model_scale_label.left = ve_window.align_left(model_scale_label);
model_scale_label.caption = "Scale:";

model_scale_input = inputbox:new();
model_scale_input.parent = ve_window;
model_scale_input.font = body_font;
model_scale_input.top = model_scale_label.top;
model_scale_input.left = ve_window.align_left(model_scale_input);
