...
elogo.parent = viewer;
elogo.left = ((viewer.width - viewer.margin_left - viewer.margin_right) * 0.5) - (elogo.width * 0.5);
elogo.top = viewer.margin_top;
grid.alpha = 128;
...
grid.on_draw = function()
    ...
    source = "\\\\fontsize{18mm}{14mm}\\\\usefont{T1}{pag}{b}{n}GLO \\\\newline\\\\fontsize{14mm}{14mm}\\\\usefont{T1}{pag}{m}{n}WERK \\\\newline \n"..source;
